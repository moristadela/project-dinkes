        ...
        <table class="min-w-full border border-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-4 py-2 text-center text-xs font-medium text-gray-500 uppercase">Last Update</th>
            ...
            {{--  <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 text-center">
                        @if($url->password)
                            <span class="px-2 py-1 bg-green-200 text-green-700 rounded text-xs">yes</span>
                        @else
                            <span class="px-2 py-1 bg-red-200 text-red-700 rounded text-xs">no</span>
                        @endif
                    </td>
                    <td class="px-4 py-2 text-center text-sm text-gray-500">
                        {{ $url->valid_until ?? 'none' }}
                    </td>
