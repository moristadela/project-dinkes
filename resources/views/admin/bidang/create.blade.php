...
<div class="max-w-4xl mx-auto p-6">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Buat Bidang Baru</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.bidang.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_bidang" id="nama_bidang" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" required>
                @error('nama_bidang')
